...
const ProductSalesActivity = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      <div className="px-3 pt-3 bg-neutral-100 dark:bg-contentBgColor shadow-navbar rounded-md">
      ...
      <div className="px-3 py-3 bg-neutral-100 dark:bg-contentBgColor shadow-navbar rounded-md">
